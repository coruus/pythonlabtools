...
"""
_rcsid="$Id: r250.py,v 1.9 2005-07-01 19:48:25 mendenhall Exp $"
...
class ran_shift(random.Random):
	...
	def __init__(self, seed=None):
		...
		self.seed(seed)
		self.mask32=Numeric.array(0x7ffffe00, Numeric.Int32)
	...
	def seed(self, seed=None):
		...
		self.ranbuf=Numeric.array(seeds, Numeric.Int32)
